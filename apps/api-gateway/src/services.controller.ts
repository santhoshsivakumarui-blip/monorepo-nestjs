...
import { withRetry, withTimeout } from "../../../libs/common/src/resilience";
...
export class ServicesController {
  ...
  get(@Param("service") service: string, @Param("resource") resource: string) {
    return this.forward(service, "GET", `/${resource}`);
  }
  ...
  post(
    ...
    return this.forward(service, "POST", `/${resource}`, body, headers);
  }
}
